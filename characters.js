const characters = {
    ...
    21: { id: 21, name: "Nobara Kugisaki", rarity: "SSR", image: "../assets/img/chars/SSRnobara.png" },
    22: { id: 22, name: "Satoru Gojo", rarity: "SSR", image: "../assets/img/chars/SSRgojo.png" },
    23: { id: 23, name: "Yuji Itadori", rarity: "SSR", image: "../assets/img/chars/SSRitadori.png" },
    24: { id: 24, name: "Maki Zenin", rarity: "SSR", image: "../assets/img/chars/SSRmaki.png" },
    25: { id: 25, name: "Megumi Fushiguro", rarity: "SSR", image: "../assets/img/chars/SSRmegumi.png" },
    26: { id: 26, name: "Kento Nanami", rarity: "SSR", image: "../assets/img/chars/SSRnanami.png" },
    27: { id: 27, name: "Aoi Todo", rarity: "SSR", image: "../assets/img/chars/SSRtodo.png" },
    28: { id: 28, name: "Panda", rarity: "SSR", image: "./assets/img/chars/SSRpanda.png" },

    29: { id: 29, name: "Megumi Fushiguro (Domain Expansion)", rarity: "SSR", image: "../assets/img/chars/megumi_domain/SSRmegumi_domain.png" },

    30: { id: 30, name: "Panda", rarity: "SR", image: "../assets/img/chars/banner_0/SRpanda.png" },
    31: { id: 31, name: "Toge Inumaki", rarity: "SR", image: "../assets/img/chars/banner_0/SRtoge.png" },
    32: { id: 32, name: "Yuta Okkotsu", rarity: "SSR", image: "../assets/img/chars/banner_0/SSRyuta.png" },
};
